defmodule PearsWeb.ImageControllerTest do
  use PearsWeb.ConnCase

  alias Pears.Images

  @create_attrs %{binary_data: "some binary_data", binary_type: "some binary_type"}
  ...
  describe "update image" do
    ...
    test "redirects when data is valid", %{conn: conn, image: image} do
      ...
      assert html_response(conn, 200) =~ "some updated binary_type"
    end
